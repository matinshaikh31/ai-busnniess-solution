...
const ProductList = ({ products }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {products?.map(
        (product) => (
          // console.log("ProductList -> product", product.product_name),
          (
            <div
              key={product.id}
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between items-center mb-3">
                  ...
                  <div className="text-xs text-gray-500">
                    Min order: {product?.company_metadata.min_order}
                  </div>
                </div>
                ...
                <div className="flex items-center mb-3 text-sm">
                    ...
                    {[...Array(5)].map((_, i) => (
                      <FaStar
                        ...
                        className={
                          i <
                          Math.floor(
                            parseFloat(product?.customer_reviews.split(" ")[0])
                          )
                            ? "text-yellow-400"
                            : "text-gray-300"
                        }
                  ...
                  <span className="text-gray-600">
                    {product?.customer_reviews.split(" | ")[1]}
                  </span>
                </div>
                ...
                <div className="mb-3">
                  <div className="flex items-center mb-1">
                    ...
                    <span className="text-sm text-gray-600">
                      {product?.industries_served.join(", ")}
                    </span>
                  </div>
